  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-20">
      <div className="w-full max-w-md p-8 rounded-2xl bg-white border border-gray-200 shadow-xl">
        ...
        <button onClick={handleGoogleSignup} className="w-full py-3 px-4 rounded-lg font-semibold flex items-center justify-center gap-3 mb-6 bg-gray-100 hover:bg-gray-200 transition-colors">
        ...
        <p className="text-center mt-6 text-gray-600">
          ...
          <Link to="/login" className="text-gray-900 hover:text-gray-700 font-semibold">Sign in</Link>
        </p>
      </div>
    </div>
  );
